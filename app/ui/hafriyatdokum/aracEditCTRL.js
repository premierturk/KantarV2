app.controller("AracEditCtrl", function ($scope, $localStorage, $modalInstance, $modal, parameter, isEdit, kendoExt, $log, $timeout, SweetAlert) {
  var firmaid;
  var aracid;
  ...
  $scope.HGSEtiketCtrl = function () {
    if ($scope.arac.HGSEtiketNo != null && $scope.arac.HGSEtiketNo != "" && $scope.arac.HGSEtiketNo != $scope.uneditedHGS)
